...
import driver1 from "drivers/1.js";
import driver2 from "drivers/2.js";
import driver3 from "drivers/3.js";
...
class MapPage extends Component{
  constructor(props) {
    ...
    this.state = {
      selectDriver: null,
      drivers: [{
        id: 0, lng: driver1.origin.lng, lat: driver1.origin.lat, origin: driver1.origin, destination: driver1.destination, direction: null, isOpen: false, balloonText: 'Иван Иванович'
      },
      {
        id: 1, lng: driver2.origin.lng, lat: driver2.origin.lat, origin: driver2.origin, destination: driver2.destination, direction: null, isOpen: false, balloonText: 'Петр'
      },
      {
        id: 2, lng: driver3.origin.lng, lat: driver3.origin.lat, origin: driver3.origin, destination: driver3.destination, direction: null, isOpen: false, balloonText: 'Николай Максимов'
      }]
    };
      ...
      <Fragment>
        <this.CMap center={{ lat: 25.03, lng: 121.6 }} driver={ this.state.drivers[0] } >
          ...
          { this.state.drivers.map((driver) => <Marker
              key={driver.id} position={{ lat: driver.lat, lng: driver.lng }} onClick={() => { this.onOpen(driver); this.setDirection(this.state.drivers[driver.id]) }}
          >
